...
namespace Emmanuel.Cryptography.GnuPG
{
    ...
    public class GnuPGWrapper
    {
        ...
        protected string BuildOptions(String fileName)
        {
        ...
        {
            ExecuteCommandMultiple(stdin, inputText, out outputText, out errorText, false);
        }

        public void ExecuteCommandMultiple(string stdin, string inputText, out string outputText, out string errorText, bool multipleArgs)
        {
            outputText = "";
